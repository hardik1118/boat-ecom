...
//        if(cart[prod_id][0]) == 0){
//            document.getElementById("addtocartbtnout"+prod_id).innerHTML = '<button type="button" class="btn btn-sm btn-outline-secondary addtocartbtn" id="addtocartbtn"'+prod_id+'><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Add to Cart</font></font></button>';
//            $('.addtocartbtn').bind('click', handler);
//        }
